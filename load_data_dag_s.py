...
# def list_files_with_pattern(bucket, pattern):
#     blobs = bucket.list_blobs()
#     return [blob.name for blob in blobs if fnmatch.fnmatch(blob.name, pattern)]

# # List files for train, valid, and test parquet files
# train_path = list_files_with_pattern(bucket, 'data/train*.parquet')
# valid_path = list_files_with_pattern(bucket, 'data/valid*.parquet')
# test_path = list_files_with_pattern(bucket, 'data/test*.parquet')
